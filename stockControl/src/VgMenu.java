	...
	{		
		...
		while (true) 
		{
			...
			case "A":
				...
				System.out.println("\nYou have entered the following: "+newGame.title+", "+newGame.releaseYear+", "+newGame.publish+", "+newGame.dev+", "+newGame.platform+", "+Vg.price+".");
			...
			case "C":
				...
				// edit in file if game is definitely found
				if (feFound) 
				{
					saveVg();
				}
			...
			case "D":
				...
				// remove from file if game is definitely found
				if (fdFound) 
				{
					saveVg();
				}
